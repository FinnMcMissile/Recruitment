					...
					<div class="card">
						<div class="card-body">
							<div class="mb-3 row" style="display: none">
								<label for="nome" class="col-sm-3 col-form-label label-right">ID posizione</label>
								<div class="col-sm-9">
									<?php
							...
							<div class="mb-3 row">
								...
								<div class="col-sm-9">
									<?php
										echo("<textarea class='form-control' id='descrizione' name='txtrequisiti' required>".$riga['Requisiti']."</textarea>");
									?>
								</div>
							</div>
							<div>
