	...
	<body>
		...
		<div class="container">
			<div class="offset-md-1 mt-2">
				...
				<a href="./Nuovo_candidato.php">Aggiungi <i class="fa fa-user-plus"></i></a>
			</div>
				...
				<table class="table">
					...
					<tbody>
						<?php
							...
							$stringa_query="SELECT * FROM candidati";
							$risultato=$connessione->query($stringa_query);
							while($riga=$risultato->fetch_assoc())
							{
								echo("<tr><td scope='row'>".$riga['Nome']."</td><td>".$riga['Cognome']."</td><td>".$riga['Email']."</td>");
								echo("<td class='no-border'><a href='Modifica_candidato.php?idcandidato=".$riga['ID_candidato']."'><i class='fa fa-pencil'></i></a></td><td class='no-border'><a href='Elimina_candidato.php?idcandidato=".$riga['ID_candidato']."'><i class='fa fa-trash'></i></a></td></tr>");
							}
						?>
					</tbody>
				</table>
