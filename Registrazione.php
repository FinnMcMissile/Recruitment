<?php
	...
	{
		die("La lunghezza della password deve essere compresa tra gli 8 e i 20 caratteri.".$tornaindietro);
	}
	...
	$stringa_query="INSERT INTO utenti (Nome, Cognome, Email, Password, N_telefonico, Bloccato) VALUES('$nome','$cognome','$email','$password_hash','$telefono',true)";
	$risultato=$connessione->query($stringa_query);
	if($risultato==false)
	{
		echo("<h1>Errore nella registrazione</h1>");
